namespace eval ::optrace {
  variable script "G:/IC Desing/IC-desing/Proyecto PONG/Anteproyectos para pong/Project 9 - Introduction to VGA/Project 9 - Introduction to VGA.runs/impl_1/top.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir {G:/IC Desing/IC-desing/Proyecto PONG/Anteproyectos para pong/Project 9 - Introduction to VGA/Project 9 - Introduction to VGA.cache/wt} [current_project]
  set_property parent.project_path {G:/IC Desing/IC-desing/Proyecto PONG/Anteproyectos para pong/Project 9 - Introduction to VGA/Project 9 - Introduction to VGA.xpr} [current_project]
  set_property ip_output_repo {{G:/IC Desing/IC-desing/Proyecto PONG/Anteproyectos para pong/Project 9 - Introduction to VGA/Project 9 - Introduction to VGA.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet {{G:/IC Desing/IC-desing/Proyecto PONG/Anteproyectos para pong/Project 9 - Introduction to VGA/Project 9 - Introduction to VGA.runs/synth_1/top.dcp}}
OPTRACE "read constraints: implementation" START { }
  read_xdc {{G:/IC Desing/IC-desing/Proyecto PONG/Anteproyectos para pong/Constraints/Constraints_Project 9.xdc}}
