set_property SRC_FILE_INFO {cfile:{G:/IC Desing/IC-desing/Proyecto PONG/Anteproyectos para pong/Constraints/Constraints_Project 9.xdc} rfile:{../../../../Constraints/Constraints_Project 9.xdc} id:1} [current_design]
