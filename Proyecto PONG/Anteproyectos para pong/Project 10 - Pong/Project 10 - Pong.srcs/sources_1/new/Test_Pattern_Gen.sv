...
Sync_To_Count #(.TOTAL_COLS(TOTAL_COLS),
                .TOTAL_ROWS(TOTAL_ROWS)) Sync_To_Count_Instance                         
(.i_clk      (i_clk),
 .i_HSync    (i_HSync),
 .i_VSync    (i_VSync),
 .o_HSync    (w_HSync),
...
/////////////////////////////////////////////////////////////////////////////
  ...
  /////////////////////////////////////////////////////////////////////////////
  // Pattern 4: Checkerboard white/black (solo en zona activa)
  /////////////////////////////////////////////////////////////////////////////
  assign Pattern_Red[4] = (w_Col_Count < ACTIVE_COLS && w_Row_Count < ACTIVE_ROWS) ?
                          (w_Col_Count[5] ^ w_Row_Count[5] ? {VIDEO_WIDTH{1'b1}} : 0) : 0;
  ...
  // Color pattern solo dentro de la zona activa
  assign Pattern_Red[5] = (w_Col_Count < ACTIVE_COLS && w_Row_Count < ACTIVE_ROWS &&
                          (w_Bar_Select == 4 || w_Bar_Select == 5 ||
                           w_Bar_Select == 6 || w_Bar_Select == 7)) ?
	                        {VIDEO_WIDTH{1'b1}} : 0;
  
  assign Pattern_Grn[5] = (w_Col_Count < ACTIVE_COLS && w_Row_Count < ACTIVE_ROWS &&
                          (w_Bar_Select == 2 || w_Bar_Select == 3 ||
	                         w_Bar_Select == 6 || w_Bar_Select == 7)) ?
                          {VIDEO_WIDTH{1'b1}} : 0;
  
  assign Pattern_Blu[5] = (w_Col_Count < ACTIVE_COLS && w_Row_Count < ACTIVE_ROWS &&
